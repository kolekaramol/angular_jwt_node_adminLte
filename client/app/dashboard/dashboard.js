angular.module('sample.dashboard', [
  ...
  .config(['$stateProvider', 'KeepaliveProvider', 'IdleProvider',function ($stateProvider, KeepaliveProvider, IdleProvider) {
    IdleProvider.idle(5);
  ...
  .controller('DashboardCtrl',['$scope', '$http', 'store', 'jwtHelper', '$state', 'Idle', 'Keepalive', '$interval', function DashboardController($scope, $http, store, jwtHelper, $state, Idle, Keepalive, $interval) {
